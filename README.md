...
|5| AWS-CICD 자동화 |  Spring Boot 애플리케이션의 개발 및 배포 과정 자동화 | EC2, S3, Linux, Jenkins, Docker | [AWS-CICD자동화](https://github.com/seungji2001/AWS-CICD-Demo.git)|4|
...
|6|Terraform & 3Tier 기본 구조|Terraform을 사용하여 VPC, 서브넷(공개/비공개), 게이트웨이(인터넷/NAT), 라우팅 테이블, 보안 그룹을 구성하고, 각 계층(웹/앱/DB)에 맞는 EC2와 RDS 인스턴스를 배치하여 안전하고 확장 가능한 3-Tier 아키텍처를 AWS 상에 자동으로 구축합니다.|linux, Terraform, AWS|[Terraform & 3Tier 기본 구조](https://github.com/seungji2001/DevPortfolio/blob/15e16a71938f8adec94ca076b161f251adad1691/DevOps/Terraform_3Tier.md)|
